...
In the first section, you will gain a grounding in the PHP programming language, covering the basics of syntax, arrays, functions, and objectoriented programming.
...
“Learning PHP, MySQL & JavaScript, 7th Edition by Robin Nixon (O’Reilly). Copyright 2025 Robin Nixon, 978-1-098-15235-2.”
...
We have a web page for this book, where we list errata, examples, and any additional information. You can access this page at https://oreil.ly/learningphp-mysql-js-7e.
...
I would like to thank Senior Content Acquisitions Editor Amanda Quinn, Content Development Editors Rita Fernando and Michele Cronin, and everyone who worked so hard on this book, including Michal Špaček and

David Mackey for their comprehensive technical reviews, Michal Špaček for his excellent help during production, Elizabeth Faerm for overseeing production, Beth Richards for copy editing, Kim Cofer for proofreading, Sue Klefstad for creating the index, Karen Montgomery for the original sugar glider front cover design, Susan Brown for the latest book cover, my original editor, Andy Oram, for overseeing the first five editions, and everyone else too numerous to name who submitted errata and offered suggestions for this new edition.