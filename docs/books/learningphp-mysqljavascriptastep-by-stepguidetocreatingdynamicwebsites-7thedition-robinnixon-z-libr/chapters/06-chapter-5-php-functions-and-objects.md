...
5. To incorporate one file within another, you can use the include or require directives or their safer variants, include\_once and require\_once.  
...
9. To cause an object to be initialized when you create it, you can call a piece of initializing code by creating a constructor method called \_\_construct within the class and place your code there.  
