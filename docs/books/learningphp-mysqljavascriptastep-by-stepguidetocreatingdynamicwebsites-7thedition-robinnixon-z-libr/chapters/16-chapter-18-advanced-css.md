...
2. The property you use to specify the size of a background image is backgroundsize, like this:
...
17. To specify the flow direction of a grid container, use the container’s gridauto-flow property.  
